...
- В выбор фреймов добавлена возможность выбрать все фреймы для раздела
- Редактор спрайтов: добавлено popup-menu для слоев
- Исправление некоторых ошибок

### v5.1.1 (14.07.2026)

- Пользовательские свойства для сцены
- Небольшие косметические правки/улучшения
- Исправление некоторых ошибок

### v5.1.0 (17.06.2026)

- Редактор сетки: кнопка для вывода подложки на передний план
- Сборщик для сцены: у слоя "сетка" добавилась возможность отрисовать "сетку"
- Сборщик для сцены: добавлен новый слой "фреймы"
- Небольшие косметические правки/улучшения
- Исправление некоторых ошибок

### v5.0.0 (05.04.2026)

- Обновлено до 21 angular & material
- Обновлена UI-библиотека
- Изменен дизайн
- Отказ от @ngrx/component-store
- Большой рефакторинг кода

### v4.0.1

- (BUG) При импорте проекта исправлен текст "Импорт спрайта..." на "Импорт проекта..."
